...
int main()
{
	...
	HorseManagers horse_play(h_population, h_num);
	horse_play.make_random_number(h_population);
	horse_play.make_winner_flag(h_population);
	horse_play.initial_winner_flag(h_population);
	horse_play.play(h_population);
	horse_play.consider_winner(h_population);
	return 0;
}
